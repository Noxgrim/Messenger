...
public class Settings {
	...
	/**
	 * The location of the configuration file. Can be set via Command line
	 * arguments.
	 */
	@IOHandler(save = false, load = false)
	...
	/**
	 * The character that separates the different sections of a Message from
	 * each other.<br>
	...
	/**
	 * The boolean that determines if the program starts in terminal or GUI
	 * mode.
	 */
	...
	/**
	 * The boolean that determines if debug messages will be printed. Can be set
	...
	/**
	 * The custom char set. If {@code "DEAFULT"} the {@code DEFAULT} char set
	 * will be loaded.
	 */
	...
	/**
	 * Constructs a new {@code Settings } object and loads its values from the
	 * {@code messenger.cfg} file.
	 * 
	 * @param core
	 *            The parent {@code Core} object.
	 */
	 ...
	 * <tr>
	 * <td>{@code "default"}</td>
	 * <td>Creates a {@code Settings} object with the default values. (default
	 * action)</td>
	 * </tr>
	 * </table>
	 * 
	 ...
	 *            The parent {@code Core} object.
	 * @param creationType
	 *            The type of the creation. See above.
	 * @param fileLocation
	 *            the location of the file that will be saved and loaded from.
	 */
	public Settings(Core core, String creationType, String fileLocation) {
		...
		case "default":
			...
			break;
		default:
			throw new IllegalArgumentException("\"" + creationType
					+ "\" is not supported");
		}
	 ...
	 * 
	 * @param from
	 *            {@code Settings} used to construct this {@code Settings}.
	 */
	 ...
	 * 
	 * @param msgLenLimit
	 *            The message length limit to be set.
	 */
	public void setMsgLenLimit(int msgLenLimit) {
		this.msgLenLimit = this.validateInt(msgLenLimit, 1, Integer.MAX_VALUE,
				this.msgLenLimit);
	}
	 ...
	 * 
	 * @param headerLenLimit
	 *            The header length limit to be set.
	 */
	public void setHeaderLenLimit(int headerLenLimit) {
		this.headerLenLimit = this.validateInt(headerLenLimit, 64,
				Integer.MAX_VALUE, this.headerLenLimit);
	}
	 ...
	 * 
	 * @param headerLenLimit
	 *            The nickname length limit to be set.
	 */
	public void setNickLenLimit(int nickLenLimit) {
		this.nickLenLimit = this.validateInt(nickLenLimit, 1,
				Integer.MAX_VALUE, this.nickLenLimit);
	}
	 ...
	 * 
	 * @param sessionKeyLen
	 *            The session key length to be set.
	 */
	public void setSessionKeyLen(int sessionKeyLen) {
		this.sessionKeyLen = this.validateInt(sessionKeyLen, 8,
				Integer.MAX_VALUE, this.sessionKeyLen);
	}
	 ...
	 *            The minimum timeout time is {@code 1000} milliseconds (1
	 *            second).
	 */
	public void setConnectionTimeout(int conectionTimeout) {
		this.connectionTimeout = this.validateInt(conectionTimeout, 1000,
	 ...
	 * 
	 * @return {@code true} if the user interface is in 'GUI' mode and
	 *         {@code false} if the user interface is in 'terminal' mode.
	 */
	 ...
	 * While {@code true} means the user interface is in 'GUI' mode and
	 * {@code false} means the user interface is in 'terminal' mode.
	 * 
	 * @param guiMode
	 *            the user interface mode to be set.
	 */
	 ...
	 * 
	 * @param exceptions
	 *            if {@code Exceptions} are printed or not.
	 */
	 ...
	 * 
	 * @param debug
	 *            if the program runs in debug mode or not.
	 */
	 ...
	 * 
	 * @return the selected custom char set or {@code "DEFAULT"} for the default
	 *         char set.
	 */
	public String getCharSet() {

		return (this.charSet.equalsIgnoreCase("DEFAULT")) ? DEFAULT_CHAR_SET
				: this.charSet;
	...
	/**
	 * Set the char set. <br>
	 * If {@code "DEFAULT"} the {@code DEFAULT_CHAR_SET} will be selected, else
	 * the new char set will be set. A char set can only contain each character
	 * once and cannot contain one of the control characters.
	 * 
	 * @param customCharSet
	 *            The char set to be set.
	 */
	 ...
	 * A nickname cannot be longer than the nickname length limit. A longer
	 * nickname will be trimmed.
	 * 
	 * @param ownNick
	...
	/**
	 * Sets the host of the internal server. should be a IP or
	 * {@code "localhost"}.
	 * 
	 * @param host
	 *            The host to be set.
	...
	/**
	 * Sets the port number of the internal server. (Will be used after
	 * restart.) <br>
	 * The minimum port number is {@code 1025}, the maximum {@code 49151} and
	 * default is {@code 1337}.
	 * 
	 * @param port
	...
	/**
	 * Gets the character that separates the different sections of a Message
	 * from each other.<br>
	 * (<code>U+001D</code>, 'Group separator'-character)
	 */
	 ...
	 * 
	 * @param newLocation
	 *            Requirements: - Must be a file. - Must be readable. - Must be
	 *            writable.
	 * @throws IllegalArgumentException
	 *             If the string is empty, does not contain a file path or the
	 *             file is not accessible.
	 */
	public void setDbLocation(String newLocation) {
		if (newLocation == null || newLocation.isEmpty()) {
			throw new IllegalArgumentException(
					"No location specified in Settings.setDbLocation(String).");
		}
		File testFile = new File(newLocation);
		if (!testFile.isFile() || !testFile.canRead() || !testFile.canWrite()) {
			throw new IllegalArgumentException(
					"Specified location is no file or not readable/writable.");
		}
		dbLocation = newLocation;
	}

	/**
	 * Sets all values of the Settings object to the default ones and generates
	 * a new key pair. <br>
	 * <br>
	 * Defaults:<br>
	 * <table>
	 ...
	 * 
	 * @param save
	 *            if set to true the changes will be saved.
	 */
	...
	/**
	 * Saves the settings in a configuration file. If such a file does not exist
	 * it will be created.<br>
	 * <br>
	 * 
	 * This method tries to save a field by invoking the corresponding
	 * <code>getter</code>-method. The default getter name will be created with
	 ...
	 * </pre>
	 * 
	 * If you want to avoid the saving of a field you can use the
	 * <code>save</code> value of {@link IOHandler}, If your field has a getter
	 * but it has a slightly different name as the default creation syntax you
	 * can specify it with the <code>getter</code> value of {@link IOHandler}.
	 * This value has to be the exact name of the method (So it will not just
	 * replace <code>field name</code> in the creation syntax.) Also, a comment
	 * will be saved behind the value if <code>comment</code> is specified.<br>
	...
	public void save() {
		...
		try (BufferedWriter br = new BufferedWriter(new FileWriter(new File(
				fileLocation)))) {
	...
	/**
	 * Loads the configuration file. If one of the keys is unknown or the value
	 * couldn't be parsed the default settings will be loaded. If one of the
	 * values in invalid it will be replaced with the corresponding default
	 * value. If the file does not exist it will be created and the default
	 * values will be loaded.<br>
	 * <br>
	 * 
	 * This method tries to load a field by invoking the corresponding
	 * <code>setter</code>-method. The default setter name will be created with
	 * the following syntax:
	 * 
	 * <pre>
	 * 'set' + field name
	 * </pre>
	 * 
	 * If you want to avoid the loading of a field you can use the
	 * <code>load</code> value of {@link IOHandler}, If your field has a setter
	 * but it has a slightly different name as the default creation syntax you
	 * can specify it with the <code>setter</code> value of {@link IOHandler}.
	 * This value has to be the exact name of the method (So it will not just
	 ...
	 * @param min
	 *            Minimal allowed value. ({@code >=})
	 * @param max
	 *            Maximal allowed value. ({@code <=})
	 * @param ifInvalid
	 *            Value that will be returned if the integer is invalid.
	 ...
	 * 
	 * @param customCharSet
	 *            Char set to be validated.
	 * @return {@code this.charSet} if {@code customCharSet} is {@code null} or
	 *         empty. Illegal characters will be removed.
	 */
	private String validateCharSet(String customCharSet) {
		if (customCharSet.isEmpty() || customCharSet == null) {
			try {
				throw new FormatException(
						"The new char set cannot be empty or null.");
			} catch (FormatException e) {
				parent.printError(null, e, false);
			}
			return this.charSet;
		}
		if (customCharSet.equalsIgnoreCase("DEFAULT")
				|| customCharSet.equals(DEFAULT_CHAR_SET))
			return "DEFAULT";
		else {
			String back = "";
			...
			if (back.isEmpty()) {
				try {
					throw new FormatException(
							"The new char set cannot be empty.");
				} catch (FormatException e) {
					parent.printError(null, e, false);
				}
				return this.charSet;
	 ...
	 * 
	 * @param nick
	 *            The nickname to be validated.
	 * @param minLen
	 *            The minimal allowed length of the nickname in characters. (>=)
	 * @param maxLen
	 *            The maximal allowed length of the nickname in characters. (>=)
	 * @return the nickname itself if it's valid, {@code "MissingNo"} if the
	 *         name is too short and a shortened name if the name is too long.
	 */
	private String validateNick(String nick, int minLen, int maxLen) {
		...
		if (nick.length() < minLen) {
			try {
				throw new FormatException(
						"Nickname too short. (1 character minimum.)");
			} catch (FormatException e) {
				parent.printError(null, e, false);
			}
			return "MissingNo";
		...
		try {
			throw new FormatException("Nickname too long. (" + maxLen
					+ " character" + ((maxLen == 1) ? "" : "s") + " maximum.)");
		} catch (FormatException e) {
			parent.printError(null, e, false);
		}
	...
	/**
	 * Equalises all values of this {@code Settings} object with the ones of
	 * another.
	 * 
	 * @param with
	 *            The {@code Settings} object that is used as model.
	 */
	...
	/**
	 * Placed over a field, this annotation will specify whether the field will
	 * be loaded or saved and can specify a comment behind the saved value. If
	 * the names of the getters and setters varies from the name of the field
	 * the <code>getter</code> and <code>setter</code> values can be used to
	 * specify them.<br>
	 * If <code>setter</code> isn't set but <code>getter</code> is, the
	 * <code>load</code>-method will generate it by switching the <code>s</code>
	 * with a <code>g</code>.<br>
	 * Default values:
	 * <ul>
